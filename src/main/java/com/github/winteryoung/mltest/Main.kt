...
fun main(args: Array<String>) {
    ...
    val nn = NeuralNetwork(layerSizes = listOf(784, 30, 10), learningRate = 1.0)
    nn.train(trainingData.map { it.toLabeledData() }.toMutableList(), epochs = 300, miniBatchSize = 100) {
